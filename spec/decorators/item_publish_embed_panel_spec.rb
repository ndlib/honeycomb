  ...
  describe "display" do
    it "renders a react component" do
      expect(subject.h).to receive(:react_component).with(
        ...
        embedPanelTitle: "Embed",
        embedPanelHelp: "Copy and paste this code into the website where you want to embed this item.",
        published: true,
        publishPath: "/items/1/publish",
        unpublishPath: "/items/1/unpublish"
      )
      subject.display
    end
  end
